...
// Get assigned members with their time slots from bookings table
...
if ($_POST && isset($_POST['action'])) {
    if ($_POST['action'] == 'update_time_slot') {
        ...
        if ($conflictCheck->rowCount() > 0) {
            $_SESSION['error'] = "Time slot conflicts with existing schedule!";
        } else {
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="bi bi-person-badge"></i> Trainer Management</h1>
            <a href="trainer_dashboard.php" class="btn">
        ...
        <div class="capacity-indicator">
            ...
            <p class="member-count"><?= $currentMembers ?> out of 5 members assigned</p>
        ...
        <div class="card">
            ...
            <?php else: ?>
                ...
                <h4 style="margin-top: 2rem; margin-bottom: 1rem; color: var(--primary);">
                    <i class="bi bi-gear"></i> Manage Member Time Slots
                </h4>
    ...
    <script>
        ...
        // Add real-time capacity indicator update
        function updateCapacityIndicator() {
            const capacityFill = document.querySelector('.capacity-fill');
            const currentMembers = <?= $currentMembers ?>;
            const percentage = (currentMembers / 5) * 100;
